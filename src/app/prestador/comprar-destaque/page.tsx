...
export default function ComprarDestaquePage() {
  ...
  useEffect(() => {
    ...
    if (checkoutStatus === "success") {
      setMessage("Pagamento confirmado! Seu destaque será ativado em instantes.");
    } else if (checkoutStatus === "cancelled") {
      setError("Pagamento cancelado. Tente novamente quando desejar destacar seu perfil.");
    }
  }, [searchParams]);
      ...
      <main className="container mx-auto px-4 py-10 max-w-5xl space-y-8">
        <div className="text-center space-y-3">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Planos de destaque colocam seu perfil nas primeiras posições de busca
            e adicionam selos especiais para mostrar que você é prioridade na
            plataforma.
          </p>
        </div>
